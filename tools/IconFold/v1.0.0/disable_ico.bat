@if "%1" == "/?" (
	@echo This program is used to disable an ico to some specific directory and the subdirectories.
...
echo Target: %~f1
if /I "%2" == "/S" ( echo Disable with Search? [Yes] ) else ( echo Disable with Search? [No] )
